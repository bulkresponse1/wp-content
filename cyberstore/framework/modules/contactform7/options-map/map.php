...
if ( ! function_exists('cyberstore_mikado_contact_form_7_options_map') ) {

	function cyberstore_mikado_contact_form_7_options_map() {

		cyberstore_mikado_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'cyberstore'),
			'icon'	=> 'icon_mail_alt'
		));

		$panel_contact_form_style_1 = cyberstore_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'cyberstore')
		));

		//Text Typography

		$typography_text_group = cyberstore_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'cyberstore'),
			'description'	=> esc_html__('Setup typography for form elements text', 'cyberstore'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = cyberstore_mikado_add_admin_row(array(
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'cyberstore'),
		));
		...
		$typography_text_row2 = cyberstore_mikado_add_admin_row(array(
		...
		$typography_text_row3 = cyberstore_mikado_add_admin_row(array(
		...
		$typography_label_group = cyberstore_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'cyberstore'),
			'description'	=> esc_html__('Setup typography for form elements label', 'cyberstore'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = cyberstore_mikado_add_admin_row(array(
		...
		$typography_label_row2 = cyberstore_mikado_add_admin_row(array(
		...
		$background_border_group = cyberstore_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'cyberstore'),
			'description'	=> esc_html__('Setup form elements background and border style', 'cyberstore'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = cyberstore_mikado_add_admin_row(array(
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'cyberstore')
		));
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'cyberstore')
		));

		$background_border_row2 = cyberstore_mikado_add_admin_row(array(
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'cyberstore'),
		));
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'cyberstore')
		));
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'cyberstore')
		));

		$background_border_row3 = cyberstore_mikado_add_admin_row(array(
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'cyberstore'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'cyberstore'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = cyberstore_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'cyberstore'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = cyberstore_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'cyberstore'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'cyberstore'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'cyberstore'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'cyberstore'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = cyberstore_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'cyberstore'),
			'description'	=> esc_html__('Setup form elements margin', 'cyberstore'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = cyberstore_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'cyberstore'),
			'description'	=> esc_html__('Enter height for textarea form element', 'cyberstore'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = cyberstore_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'cyberstore'),
			'description'	=> esc_html__('Setup button text typography', 'cyberstore'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = cyberstore_mikado_add_admin_row(array(
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Hover Text Color', 'cyberstore')
		));
		...
		$button_typography_row2 = cyberstore_mikado_add_admin_row(array(
		...
		$button_background_border_group = cyberstore_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'cyberstore'),
			'description'	=> esc_html__('Setup button background and border style', 'cyberstore'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = cyberstore_mikado_add_admin_row(array(
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'cyberstore')
		));
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'cyberstore')
		));

		$button_background_border_row2 = cyberstore_mikado_add_admin_row(array(
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'cyberstore')
		));
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'cyberstore')
		));

		$button_background_border_row3 = cyberstore_mikado_add_admin_row(array(
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'cyberstore'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		cyberstore_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'cyberstore'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = cyberstore_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'cyberstore')
		));
        ...
        $panel_contact_form_style_3 = cyberstore_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'cyberstore')
        ));
        ...
        $typography_label_row3 = cyberstore_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = cyberstore_mikado_add_admin_row(array(
	...
	add_action( 'cyberstore_mikado_options_map', 'cyberstore_mikado_contact_form_7_options_map', 20);
}