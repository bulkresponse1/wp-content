 ...
 */
if ( ! class_exists( 'CyberstoreMikadoSidebar' ) ) {
	class CyberstoreMikadoSidebar {
		var $sidebars = array();
		var $stored = "";
		...
		function __construct() {
			...
			$this->title  = esc_html__( 'Custom Widget Area', 'cyberstore' );
		...
		function load_assets() {
			...
			wp_enqueue_script( 'cyberstore-mikado-sidebar', MIKADO_ROOT . '/framework/admin/assets/js/mkd-sidebar.js' );
			wp_enqueue_style( 'cyberstore-mikado-sidebar', MIKADO_ROOT . '/framework/admin/assets/css/mkd-sidebar.css' );
		}
		...
		function template_add_widget_field() {
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '" . esc_html__('Enter Name of the new Widget Area', 'cyberstore') . "' name='mkd-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='" . esc_html__('Add Widget Area', 'cyberstore') . "' />";
			echo "\n    " . $nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars() {
			...
			$args = apply_filters( 'cyberstore_mikado_custom_widget_args', $args );
