...
if ( ! function_exists( 'cyberstore_mikado_get_title_types_meta_boxes' ) ) {
	function cyberstore_mikado_get_title_types_meta_boxes() {
		$title_type_options = apply_filters( 'cyberstore_mikado_title_type_meta_boxes', $title_type_options = array( '' => esc_html__( 'Default', 'cyberstore' ) ) );
...
if ( ! function_exists( 'cyberstore_mikado_map_title_meta' ) ) {
	function cyberstore_mikado_map_title_meta() {
		$title_type_meta_boxes = cyberstore_mikado_get_title_types_meta_boxes();
		
		$title_meta_box = cyberstore_mikado_create_meta_box(
			array(
		...
		cyberstore_mikado_create_meta_box_field(
			...
			$show_title_area_meta_container = cyberstore_mikado_add_admin_container(
				array(
					'parent'          => $title_meta_box,
				...
				cyberstore_mikado_create_meta_box_field(
					array(
						...
						'options'       => array(
							...
							'hide'                => esc_html__( 'Hide Image', 'cyberstore' ),
							'responsive'          => esc_html__( 'Enable Responsive Image', 'cyberstore' ),
							'responsive-disabled' => esc_html__( 'Disable Responsive Image', 'cyberstore' ),
							...
							'parallax-disabled'   => esc_html__( 'Disable Parallax Image', 'cyberstore' )
						)
					)
				);
				...
				cyberstore_mikado_create_meta_box_field(
					array(
						...
						'description'   => esc_html__( 'Specify title area content vertical alignment', 'cyberstore' ),
						'parent'        => $show_title_area_meta_container,
						'options'       => array(
							''              => esc_html__( 'Default', 'cyberstore' ),
				...
				cyberstore_mikado_create_meta_box_field(
					array(
						...
						'options'       => cyberstore_mikado_get_title_tag( true ),
						'parent'        => $show_title_area_meta_container
					)
				);
				...
				cyberstore_mikado_create_meta_box_field(
					array(
						...
						'type'        => 'color',
						'label'       => esc_html__( 'Title Color', 'cyberstore' ),
						'description' => esc_html__( 'Choose a color for title text', 'cyberstore' ),
						'parent'      => $show_title_area_meta_container
					)
				);
				...
				cyberstore_mikado_create_meta_box_field(
					array(
						...
						'type'          => 'text',
						'default_value' => '',
						'label'         => esc_html__( 'Subtitle Text', 'cyberstore' ),
						'description'   => esc_html__( 'Enter your subtitle text', 'cyberstore' ),
						'parent'        => $show_title_area_meta_container,
						'args'          => array(
							'col_width' => 6
						)
				...
				cyberstore_mikado_create_meta_box_field(
					array(
						...
						'options'       => cyberstore_mikado_get_title_tag( true, array( 'p' => 'p' ) ),
						'parent'        => $show_title_area_meta_container
					)
				);
				...
				cyberstore_mikado_create_meta_box_field(
					array(
						...
						'type'        => 'color',
						'label'       => esc_html__( 'Subtitle Color', 'cyberstore' ),
						'description' => esc_html__( 'Choose a color for subtitle text', 'cyberstore' ),
						'parent'      => $show_title_area_meta_container
					)
				);
		...
		do_action( 'cyberstore_mikado_additional_title_area_meta_boxes', $show_title_area_meta_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
	}
	
	add_action( 'cyberstore_mikado_meta_boxes_map', 'cyberstore_mikado_map_title_meta', 60 );
}