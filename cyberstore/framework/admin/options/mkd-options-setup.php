...
if ( ! function_exists( 'cyberstore_mikado_admin_map_init' ) ) {
	function cyberstore_mikado_admin_map_init() {
		do_action( 'cyberstore_mikado_before_options_map' );
		...
		do_action( 'cyberstore_mikado_options_map' );
		
		do_action( 'cyberstore_mikado_after_options_map' );
	}
	
	add_action( 'after_setup_theme', 'cyberstore_mikado_admin_map_init', 1 );
}