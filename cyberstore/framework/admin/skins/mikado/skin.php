...
class MikadoSkin extends CyberstoreMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to cyberstore_mikado_admin_scripts_init and cyberstore_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('cyberstore_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('cyberstore_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('cyberstore_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('cyberstore_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('cyberstore_mikado_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('cyberstore_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        $this->scripts['select2'] = 'assets/js/mkd-ui/select2.min.js';

        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            cyberstore_mikado_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            cyberstore_mikado_register_skin_style($styleHandle, $stylePath);
        }
    }
    ...
    public function renderOptions() {
        ...
        $tab    		= cyberstore_mikado_get_admin_tab();
        $active_page 	= $cyberstore_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
     * @see CyberstoreMikadoSkinAbstract::loadTemplatePart()
     */
     ...
     *
     * @param CyberstoreMikadoAdminPage $page current page to load
	...
	public function renderBackupOptions() { ?>
		<div class="mkd-options-page mkd-page">
			<?php $this->getHeader(cyberstore_mikado_get_theme_info_item('Name'), cyberstore_mikado_get_theme_info_item('Version'), false); ?>
			<div class="mkd-page-content-wrapper">
				<div class="mkd-page-content">
					<div class="mkd-page-navigation mkd-tabs-wrapper vertical left clearfix">
