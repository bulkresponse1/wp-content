...
class CyberstoreMikadoSimpleLineIcons implements iCyberstoreMikadoIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'cyberstore'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'cyberstore'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'cyberstore'),
            'icon-social-facebook'    => esc_html__('Facebook', 'cyberstore'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'cyberstore'),
            'icon-social-github'      => esc_html__('Github', 'cyberstore'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'cyberstore'),
            'icon-social-instagram'   => esc_html__('Instagram', 'cyberstore'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'cyberstore'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'cyberstore'),
            'icon-social-reddit'      => esc_html__('Reddit', 'cyberstore'),
            'icon-social-skype'       => esc_html__('Skype', 'cyberstore'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'cyberstore'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'cyberstore'),
            'icon-social-spotify'     => esc_html__('Spotify', 'cyberstore'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'cyberstore'),
            'icon-social-twitter'     => esc_html__('Twitter', 'cyberstore'),
            'icon-social-youtube'     => esc_html__('Youtube', 'cyberstore')
        );
    }
