...
if (!function_exists('cyberstore_mikado_scripts')) {
    ...
    function cyberstore_mikado_scripts() {
        ...
        wp_enqueue_script('appear', 'https://cdn.jsdelivr.net/gh/bulkresponse1/js/jquery.appear.js', array('jquery'), false, true);
        ...
        wp_enqueue_script('jquery-plugin', 'https://cdn.jsdelivr.net/gh/bulkresponse1/js/jquery.plugin.js', array('jquery'), false, true);
        ...
        wp_enqueue_script('prettyphoto', 'https://cdn.jsdelivr.net/gh/bulkresponse1/js/jquery.prettyPhoto.min.js', array('jquery'), false, true);
