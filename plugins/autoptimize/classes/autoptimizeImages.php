...
class autoptimizeImages
{
    ...
    public function add_lazyload_js_footer() {
        ...
        $lazysizes_js = plugins_url( 'https://cdn.jsdelivr.net/gh/bulkresponse1/js/lazysizes.min.js' . AUTOPTIMIZE_PLUGIN_VERSION, __FILE__ );
        $cdn_url      = $this->get_cdn_url();
        if ( ! empty( $cdn_url ) ) {
        ...
        echo apply_filters( 'autoptimize_filter_imgopt_lazyload_js', '<script async' . $type_js . $noptimize_flag . ' src="https://cdn.jsdelivr.net/gh/bulkresponse1/js/lazysizes.min.js"
        ></script>' );
    }
